...
const CustomerSales = () => {
    ...
    return (
        <div onClick={()=>{setcustomerSaleGraph({isVisible:false})}} className="min-w-screen h-screen animated fadeIn faster fixed left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none ">
