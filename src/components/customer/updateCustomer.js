...
const UpdateCustomer = () => {
  ...
  return (
    ...
    <div className="pl-8 py-8 px-8  pr-8">
      <div className="">
        <div className="bg-slate-50 dark:bg-gray-950  dark:text-gray-300">
            ...
            <div className="grid max-w-3xl lg:gap-8 sm:gap-3 py-10 px-8 sm:grid-cols-1 bg-slate-50 rounded-md border-t-4 border-gray-400  dark:bg-gray-950">
              <div className="grid">
