...
const SignUpSuccess = () => {
  ...
  return (
    ...
    <div className="backdrop-blur-sm bg-black bg-opacity-20 w-full h-full absolute"></div>
     <div className=" max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg   bg-white z-50 max-h-screen overflow-y-auto ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="w-14 h-16 flex items-center text-green-500 mx-auto animate-bounce " viewBox="0 0 20 20" fill="currentColor">
  <path fill-rule="evenodd" d="M10 0a10 10 0 100 20 10 10 0 000-20zM8.707 13.707a1 1 0 001.414 0l6-6a1 1 0 00-1.414-1.414L9 11.586l-2.293-2.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0z" clip-rule="evenodd"/>
      ...
      <div class="p-3  mt-2 text-center space-x-4 md:block">
          <button onClick={()=>onClickOk()} class="mb-2 md:mb-0 bg-slate-400 border borde-slate-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ...">Okay</button>
      </div>
    </div>
  </div>
 </div>
