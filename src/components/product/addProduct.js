...
const AddProduct = () => {
  ...
  return (
    <div className='lg:flex lg:justify-center lg:content-center sm:ml-64  dark:bg-gray-800'>
    <div className="shadow-xl md:w-[30rem] sm:w-[20rem] mb-5 lg:mt-2  mx-auto  border dark:bg-gray-900 bg-slate-50 border-gray-300 dark:border-gray-600 rounded-xl">
      <div className="pl-8 py-8 px-8 pr-8">
        <div className="">
          <div className="bg-slate-50 dark:bg-gray-900">
            ...
            <div className="dark:bg-gray-900 grid max-w-3xl lg:gap-8 sm:gap-3 py-10 px-8 sm:grid-cols-1 bg-slate-50 rounded-md border-t-4 border-gray-400">
