...
const ViewVendors = () => {
  const { vendors, getAllVendors, deleteVendor, setVendorId, setUpdateFormValues } = useContext(VendorContext);
  ...
  const updateVendor = (vendor) => {
    ...
    setUpdateFormValues({ name: vendor.name, email: vendor.email });
  };
  ...
  return (
    <div className="dark:bg-gray-900">
      <div className="flex justify-center items-center  ">
        <div className="absolute top-0 text-center ml-52 mt-2 font-semibold text-lg dark:text-gray-300">Vendors</div>
                    ...
                    </span>
                    {
                      <button
                        onClick={() => {
                          ...
                          textField.innerText = vendor._id;
